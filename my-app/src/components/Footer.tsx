...
export default function Footer() {
  return (
    <main className='w-full flex gap-2 lg:flex-row md:flex-row flex-col justify-between items-center lg:px-20 px-6 py-4 border-t border-neutral-700 border-dashed'>
      <p>
        &copy; 2024 Your Company, Inc. All rights reserved.
      </p>
      {/* ---------------- Social Media Icons ---------------- */}
      <div className='flex space-x-2'>
        <a href="#" target='_blank' className="text-gray-400 hover:text-indigo-600 transition duration-300">
